...
<head>
    ...
    <!--[if gte mso 9]><SharePoint:CTFieldRefs runat=server Prefix="mso:" FieldList="FileLeafRef,WikiField"><xml>
<mso:CustomDocumentProperties>
<mso:display_urn_x003a_schemas-microsoft-com_x003a_office_x003a_office_x0023_SharedWithUsers msdt:dt="string">Mike Thorpe</mso:display_urn_x003a_schemas-microsoft-com_x003a_office_x003a_office_x0023_SharedWithUsers>
<mso:SharedWithUsers msdt:dt="string">555;#Mike Thorpe</mso:SharedWithUsers>
</mso:CustomDocumentProperties>
...
<body class='index'>
    ...
    <div class="container">
        ...
        <div id="EasterBanner"
            style="margin-bottom:10px;padding:0 25px;height:120px;width:98%;position:relative;border-radius:5px;background-image:url('assets/images/Banner/OfficeBookings.jpg');background-position: center;margin-left:10px">
            <!-- <div style="width: 100%;display: inline-block;position:absolute; top:-3px;left:2px"><img id='BIGQuiz' src="assets/images/Banner/KeyDrop.jpg" width="300"></div> -->
            <div align="center" style="width: 100%;">
                <div align="center" style="margin-bottom: 20px; width: 40%">
                </div>
            </div>
            <div class="keyButton">
                <div class="key"><img id='KeyNormal' src="assets/images/Banner/BookNowNormal.png"></div>
                <div class="key"><img id='KeyMouseOver' src="assets/images/Banner/BookNowMouseOver.png"></div>
                <!-- <div style="display: inline-block;position:absolute; top:27px;left:920px"><img id='ResultsBtn'
                src="assets/images/Banner/Results.png" width="150"></div> -->
            </div>
        </div>
        ...
        <div class="grid-stack">
            ...
            <div class="grid-stack-item" id="BIG2" data-gs-id="BIG2" data-gs-locked="yes" data-gs-no-resize="yes"
                ...
                <div class="grid-stack-item-content" id="MainNews">
                    <div id="defaultMain">
                        ...
                        <div class="subHeadline">Bailie Group</div>
                    ...
                    <div id="sliderMain">
                        <div class="slideContainer hide">
                            ...
                            <div id="iconBar" class="hideElement">
            ...
            <!-- People -->
            <div class="grid-stack-item" data-gs-x="0" data-gs-y="5" data-gs-width="4" data-gs-height="4"
                data-gs-min-height="2" data-gs-min-width="2" data-gs-max-height="6" data-gs-max-width="4">
                <div class="grid-stack-item-content" id="People">
                    <a href="PeopleHome.aspx"><img src="assets\images\PeopleSite\Engage2.gif" alt=""></a>
                    <!-- <div id="sliderMain">
            ...
            <!-- AskHR -->
            <div class="grid-stack-item" data-gs-x="4" data-gs-y="5" data-gs-width="4" data-gs-height="4"
                data-gs-min-height="2" data-gs-min-width="2" data-gs-max-height="6" data-gs-max-width="4">
                <div class="grid-stack-item-content" id="AskHR">
                    <div id="AskHRContent">
                        <div id="AskHRSubHeadline2" class="subHeadline2">Any Questions?</div>
                        <div id="AskHRSubHeadline" class="subHeadline">Ask People Support</div>
                    </div>
                </div>
            </div>
            ...
            <!-- JobBoard -->
            <div class="grid-stack-item" data-gs-x="8" data-gs-y="5" data-gs-width="4" data-gs-height="2"
                data-gs-min-height="2" data-gs-min-width="2" data-gs-max-height="6" data-gs-max-width="8">
            ...
            <!-- LoveMyIdeas -->
            <div class="grid-stack-item" data-gs-x="8" data-gs-y="7" data-gs-width="2" data-gs-height="2"
                data-gs-min-height="2" data-gs-min-width="2" data-gs-max-height="6" data-gs-max-width="8">
            ...
            <!-- IceAwards -->
            <div class="grid-stack-item" data-gs-x="10" data-gs-y="7" data-gs-width="2" data-gs-height="2"
                data-gs-min-height="2" data-gs-min-width="2" data-gs-max-height="6" data-gs-max-width="8">
            ...
            <!-- NoticeBoard -->
            <div class="grid-stack-item" data-gs-x="8" data-gs-y="9" data-gs-width="4" data-gs-height="3"
                data-gs-min-height="2" data-gs-min-width="2" data-gs-max-height="6" data-gs-max-width="8">
    ...
    <script>
        ...
        $('.keyButton').mouseover(() => {
            $('#KeyMouseOver').show();
            $('#KeyMouseOver').css('cursor', 'pointer')
        })
        $('.keyButton').mouseout(() => {
            $('#KeyMouseOver').hide();
            $('#KeyMouseOver').css('cursor', 'none')
        })
        $('.keyButton').click(() => {
            window.open("reservations.aspx", target = "_self")
