...
<body class="eap">
    ...
    <div class="container">
        ...
        <div class="content">
            <div class="welcome">People Data - A detailed breakdown of the monthly management information from People HR.
            </div>
            <div class="main">
                <!-- <object id="docDisplay" v-bind:data="selectedURL" type="application/pdf" height="100%" width="100%"> -->
                <object id="docDisplay" v-bind:data="selectedURL"  type="text/html" height="100%" width="100%"></object>
                </object>
            </div>
            <div class="sideBar">
    ...
    <script type="text/javascript" src="js/PeopleData.min.js"></script>
